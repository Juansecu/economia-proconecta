namespace Proconecta.Core
{
    ...
    public class ReviewBL : IReviewBL
    {
        ...
        #region Constructos
        public ReviewBL(IUnitOfWork unitOfWork)
        {
        ...
        public async Task<Review> Insert(Review toInsert)
        {
            try
            {
        ...
        public async Task<Review> Update(string id, object toUpdate)
        {
            try
            {
        ...
        public async Task<bool> Delete(string id)
        {
            ...
            {
                var oldValues = GetEntityById(id);
                _unitOfWork.ReviewRepo.Delete(oldValues);
                await _unitOfWork.CommitAsync();
                return true;
            }
            catch (Exception ex)
        ...
        private Review GetEntityById(string id)
        {
            try
            {
